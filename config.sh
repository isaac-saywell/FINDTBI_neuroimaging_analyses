...
### Threshold percentage (range from 0-1) used to binarise subject spatial maps according to their maximum intensity value

thr_rs=0.9 # quite subjective, needs to be adjusted according to the data (what is the common percent of intensities that you want to include in binarised spatial map)
